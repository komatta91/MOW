...
.C_R_addTaskCallback <- structure(list(name = "R_addTaskCallback", address = pointer("0x000000000008dfb0"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
...
.F_dqrqy <- structure(list(name = "dqrqy", address = pointer("0x000000000008e450"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
...
.F_dqrxb <- structure(list(name = "dqrxb", address = pointer("0x000000000008ddd0"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
    numParameters = 7L), class = c("FortranRoutine", "NativeSymbolInfo"
...
.F_dtrco <- structure(list(name = "dtrco", address = pointer("0x000000000008e3d0"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
...
.F_dqrcf <- structure(list(name = "dqrcf", address = pointer("0x000000000008df50"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
...
.Platform <- structure(list(OS.type = "windows", file.sep = "/", dynlib.ext = ".dll", 
    GUI = "RTerm", endian = "little", pkgType = "win.binary", 
    path.sep = ";", r_arch = "x64"), .Names = c("OS.type", "file.sep", 
...
.Options <- pairlist(prompt = "> ", continue = "+ ", expressions = 5000L, width = 80L, deparse.cutoff = 60L, digits = 7L, echo = TRUE, verbose = FALSE, check.bounds = FALSE, keep.source = FALSE, keep.source.pkgs = FALSE, warning.length = 1000L, nwarnings = 50L, OutDec = ".", browserNLdisabled = FALSE, CBoundsCheck = FALSE, matprod = "default", PCRE_study = 10L, PCRE_use_JIT = TRUE, PCRE_limit_recursion = NA, warn = 0, timeout = 60, encoding = "native.enc", show.error.messages = TRUE, scipen = 0, max.print = 99999L, add.smooth = TRUE, stringsAsFactors = TRUE, showErrorCalls = TRUE, defaultPackages = c("datasets", 
"utils", "grDevices", "graphics", "stats", "methods"), papersize = "a4", pager = "internal", useFancyQuotes = FALSE, pdfviewer = "D:/Dev/R-lang/R-3.4.0/bin/x64/open.exe", help_type = "html", help.try.all.packages = FALSE, help.search.types = c("vignette", 
...
"digits.d", "vec.len")), demo.ask = "default", example.ask = "default", HTTPUserAgent = "R (3.4.0 x86_64-w64-mingw32 x86_64 mingw32)", menu.graphics = TRUE, mailer = "mailto", install.packages.compile.from.source = "interactive", unzip = "internal", editor = "notepad", repos = structure(c("@CRAN@", 
"http://www.stats.ox.ac.uk/pub/RWin"), .Names = c("CRAN", "CRANextra"
)), locatorBell = TRUE, device.ask.default = FALSE, windowsTimeouts = c(100L, 
...
.C_R_removeTaskCallback <- structure(list(name = "R_removeTaskCallback", address = pointer("0x000000000008e0b0"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
...
.Last.value <- structure(list(help_type = NULL), .Names = "help_type")
...
.F_dqrdc2 <- structure(list(name = "dqrdc2", address = pointer("0x000000000008de30"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
...
.Library <- "D:/Dev/R-lang/R-3.4.0/library"
...
.F_dqrqty <- structure(list(name = "dqrqty", address = pointer("0x000000000008e110"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
    numParameters = 7L), class = c("FortranRoutine", "NativeSymbolInfo"
...
.F_dqrrsd <- structure(list(name = "dqrrsd", address = pointer("0x000000000008ded0"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
    numParameters = 7L), class = c("FortranRoutine", "NativeSymbolInfo"
...
.C_R_getTaskCallbackNames <- structure(list(name = "R_getTaskCallbackNames", address = pointer("0x000000000008e130"), 
    dll = structure(list(name = "base", path = "base", dynamicLookup = FALSE, 
        handle = <pointer: (nil)>, info = pointer("0x0000000006658140")), .Names = c("name", 
    "path", "dynamicLookup", "handle", "info"), class = "DLLInfo"), 
